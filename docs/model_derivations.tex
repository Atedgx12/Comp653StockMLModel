...
a small logistic unit, so the meta layer can lean on news tone when it helps. The
branch is deliberately simple because the sentiment signal is sparse in the
