...
the meta layer, and the gradient is gated by $\mathbf{1}[Z>0]$. The data view
shows the nonlinear boundary the rectified layers can represent.}
\label{fig:branchmlp}
\end{figure}
...
model lives. The boundary in Figure \ref{fig:branchmlp} is produced by this same
architecture trained on two interleaving classes, and it separates them at ninety
six percent.
