"""Sample training driver that composes the building blocks.

Run with:
    python -m scripts.train_lightgbm

The script intentionally uses a synthetic panel so it works without any
external data download. Replace the synthetic block with a real loader once
the data is staged under data/raw.
"""
